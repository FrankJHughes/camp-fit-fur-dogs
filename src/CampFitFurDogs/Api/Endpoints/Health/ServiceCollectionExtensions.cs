...
/// <summary>
/// Provides extension methods for registering all health‑related API endpoints
/// within the Camp Fit Fur Dogs application.
/// <para>
/// This class integrates the Health endpoint assembly into the Frank.Core API
/// endpoint discovery pipeline, ensuring that all <see cref="IEndpoint"/>
/// implementations under the <c>CampFitFurDogs.Api.Endpoints.Health</c> namespace
...
{
    /// <summary>
    /// Registers all health‑related API endpoints by scanning the assembly containing
    /// <see cref="CampFitFurDogs.Api.AssemblyMarker"/> and applying a namespace
    /// filter to include only endpoint implementations under the Health namespace.
    /// <para>
    ...
    /// that only health‑specific endpoints are included.
    /// </para>
    /// </summary>
    /// <param name="services">The service collection to extend.</param>
    /// <returns>
    /// The updated <see cref="IServiceCollection"/> with health‑related endpoints registered.
    /// </returns>
