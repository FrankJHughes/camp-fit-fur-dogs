...
namespace CampFitFurDogs.Api.Tests.Configuration;
...
public class CorsConfigurationTests
{
    ...
    // ---------------------------------------------------------------------
    // INTERNAL HOST BUILDER — now uses CorsConfigurator
    // ---------------------------------------------------------------------
        ...
        var builder = new HostBuilder()
            ...
            .ConfigureWebHost(webHost =>
            {
                webHost
                    ...
                    {
                        CorsConfigurator.ConfigureServices(services, ctx.Configuration);
                    })
                    .Configure(app => { });
            });
