...
## Intent
Establish contribution standards, a pull-request template, and ignore rules so that every contributor follows a consistent workflow from their first commit.
